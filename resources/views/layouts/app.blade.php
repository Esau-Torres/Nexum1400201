    ...
    <div class="d-flex">
        ...
        <aside class="sidebar bg-white border-end d-flex flex-column">
            ...
            <div class="p-3 border-bottom">
                <a href="{{ route('home') }}">
                    <img src="{{ asset('images/uma_santa_ana.png') }}" alt="Logo Universidad UMA Santa Ana" class="img-fluid" style="max-height: 50px;">
                </a>
            </div>
            ...
            <nav class="flex-grow-1 p-3">
                <ul class="nav flex-column">
                    <li class="nav-item mb-1">
                        <a href="{{ route('home') }}" class="nav-item-custom d-flex align-items-center text-decoration-none text-dark @if(request()->is('pensum')) active @endif">
                            <i class="fa-solid fa-home nav-icon fs-5 me-3 text-muted"></i>
                            <div>
                                <div class="fw-medium">Inicio</div>
                                <div class="nav-text-secondary">Planel de rutas</div>
                            </div>
                        </a>
                    </li>
                    <li class="nav-item mb-1">
            ...
            <div class="p-3 border-top">
                <a href="{{ route('profile') }}" class="nav-item-custom d-flex align-items-center text-decoration-none text-dark mb-1">
